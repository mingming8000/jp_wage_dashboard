# import numpy as np 210513 GITへの公開時に削除（以下のコードでは使用しておらず、requirementsでも記載しないため）
import pandas as pd
import streamlit as st
import pydeck as pdk
import plotly.express as px

# section72:都道府県別一人当たり平均賃金を日本地図にヒートマップ表示するための準備
...
# Section76:年齢階級別の全国一人あたり平均賃金をバブルチャート表示
...
fig2=px.bar(df_mean_categ,x=option_wage,y="産業大分類名",color="産業大分類名",animation_frame="年齢",range_x=[0,max_x],orientation="h",width=800,height=500)
